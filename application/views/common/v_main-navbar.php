    ...
    <nav>
      ...
      <ul class="nav navbar-nav navbar-right" style="width:90%">
        <li class="" style="width:30%;color:white">
          <span  href="javascript:;" class="user-profile dropdown-toggle" data-toggle="dropdown" aria-expanded="false" style="cursor:pointer"><i class="fa fa-3x fa-user simbol2"></i> Halo, <strong><?= $this->session->userdata('nama')?></strong> <i class="fa fa-angle-down"></i></span> 
        ...
        <?php if($this->session->userdata('userlevel') == 0 || $this->session->userdata('userlevel') == 1) {?>
